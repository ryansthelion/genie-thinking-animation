...
/** Version 2 — thread-bottom genie + standard ThinkingDrawer. */
export function Version2ChatRow({
  phase,
  ...
  return (
    <div className="chat-row" data-version="2" data-node-id="9982:71369">
